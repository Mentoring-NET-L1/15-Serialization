...
{
    internal class OrderDataContractSurrogate : IDataContractSurrogate
    {
        ...
        private static object GetShipperToSerialize(Shipper shipper)
        {
            return new Shipper
            {
                Phone = shipper.Phone,
        ...
        private static object GetOrderDetailToSerialize(Order_Detail orderDetail)
        {
        ...
        private static object GetCustomerToSerialize(Customer customer)
        {
            return new Customer
            {
